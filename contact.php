<!-- Page de Contact avec Navbar et un formulaire de contact -->
		...
		<div class="form">
			<form method="post">
				<div class="renseignement">
					...
					<input type="mail" placeholder = "Johnsmith@john.com" name="mail" id="id_mail"/>
					<div class="sujet">Sujet : </div>
					<input type="text" name="sujet"/>
				</div>
				<div class="message">
					<div class="mess">Message : </div>
					<textarea type="text" class="text" placeholder="Entrez votre texte içi" name="messageContent"></textarea>
				</div>
				<input type="button" class="Submit" name="submit" value="Envoyer"/>
			</form>
		</div>
	</body>
	</html>